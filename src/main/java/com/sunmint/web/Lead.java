...
public class Lead {
    ...
    public Lead(String email, String firstName, String middleName, String lastName, String city, String state, String zip, Integer monthlyBill, Integer monthlyUsage, String carrier) {
        this.email = email;
